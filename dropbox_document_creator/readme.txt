...
2.) copy main application folder dropbox_document_creator which contains the backend Code to htdocs of the Xammp server. Eg. C:\xampp\htdocs\dropbox_document_creator.
...
6.) locate and Edit Settings.php to update All Dropbox Hellosign API, ChatGPT Access Token and other Parameters where appropriates. 
